     ...
     <!--main content start-->
      <section id="main-content">
          <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i>  Informations Diabetiques</h3>
        <div class="row">
           ...
           <!-- Liste des diabetiques -->
              <div class="row mt">
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                            <h4><i class="fa fa-angle-right"></i> <?php foreach($data as $l){;?>
                              <?php echo $l['Diabetique']['nom'];?>   <?php echo $l['Diabetique']['prenom'];?>
                               <?php }
                            ;?>
                    ...
                    <img class="img-circle" width="60"
                    <?php
                        echo $this->Html->image($l['Diabetique']['avatar']);
                    ?>
                   </p></td>
                               ...
                               <tr>
                                  ...
                                  <td>Type maladie </td>
                                  <td><?php echo $l['Diabetique']['type'];?></td>
                              ...
                              <tr>
                                  ...
                                  <td><?php echo $l['Diabetique']['dateNaissance'];?></td>
                               
                              </tr>
                              <tr>
                                   
                                  <td>Sexe </td>
                                  <td><?php echo $l['Diabetique']['sexe'];?></td>
                              ...
                              <tr>
                                  ...
                                  <td><?php echo $l['Diabetique']['numeroTelephone'];?></td>
                              ...
                              <tr>
                                  ...
                                  <td>Adresse </td>
                                  <td><?php echo $l['Diabetique']['adresse'];?></td>
                              ...
                              <tr>
                                  ...
                                  <td>Poids </td>
                                  <td><?php echo $l['Diabetique']['poids'];?></td>
                              ...
                              <tr>
                                  ...
                                  <td>Taille </td>
                                  <td><?php echo $l['Diabetique']['taille'];?></td>
                              ...
                              <tr>
                                  ...
                                  <td><?php echo $l['Diabetique']['groupesanguin'];?></td>
