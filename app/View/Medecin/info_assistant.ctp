     ...
     <!--main content start-->
      <section id="main-content">
          <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> Informations Assistant</h3>
        <div class="row">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                            <h4><i class="fa fa-angle-right"></i> Assistant</h4>
                            <hr>
                     ...
                     <tr>
                              ...
                              <tr>
                                  ...
                                  <td><?php echo $l['AssistantMedical']['dateNaissance'];?></td>
                               
                              </tr>
                              <tr>
                                   
                                  <td>Sexe </td>
                                  <td><?php echo $l['AssistantMedical']['sexe'];?></td>
                              ...
                              <tr>
                                  ...
                                  <td><?php echo $l['AssistantMedical']['numeroTelephone'];?></td>
                              ...
                              <tr>
                                  ...
                                  <td>Adresse </td>
                                  <td><?php echo $l['AssistantMedical']['adresse'];?></td>
                               
                              </tr>
                              <tr>
                                   
                                  <td>Patient affecte  </td>
                                  <td><?php echo $l['AssistantMedical']['idAlzheimer'];?></td>
