     ...
     <!--main content start-->
      <section id="main-content">
          <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> Informations des grossesses</h3>
        <div class="row">
           ...
           <!-- Liste des diabetiques -->
              <div class="row mt">
                  <div class="col-md-12">
                          ...
                          <table class="table table-striped table-advance table-hover">
                            <h4><i class="fa fa-angle-right"></i> 
                             <?php foreach($data as $l){;?>
                              <?php echo $l['GrossesseArisque']['nom'];?>   <?php echo $l['GrossesseArisque']['prenom'];?>
                               <?php }
                            ;?>
                    ...
                    <img class="img-circle" width="60"
                    <?php
                        echo $this->Html->image($l['GrossesseArisque']['avatar']);
                    ?>
                   </p></td>
                     ...
                     <tr>
                                   <td>Type Maladie </td>
                                  <td><?php echo $l['GrossesseArisque']['type'];?></td>
                              ...
                              <tr>
                                  ...
                                  <td><?php echo $l['GrossesseArisque']['dateNaissance'];?></td>
                               
                              </tr>
                              <tr>
                                   
                                  <td>Sexe </td>
                                  <td><?php echo $l['GrossesseArisque']['sexe'];?></td>
                              ...
                              <tr>
                                  ...
                                  <td><?php echo $l['GrossesseArisque']['numeroTelephone'];?></td>
                              ...
                              <tr>
                                  ...
                                  <td>Adresse </td>
                                  <td><?php echo $l['GrossesseArisque']['adresse'];?></td>
                              ...
                              <tr>
                                  ...
                                  <td>Poids </td>
                                  <td><?php echo $l['GrossesseArisque']['poids'];?> kg </td>
                              ...
                              <tr>
                                  ...
                                  <td>Taille </td>
                                  <td><?php echo $l['GrossesseArisque']['taille'];?>cm </td>
                              ...
                              <tr>
                                  ...
                                  <td><?php echo $l['GrossesseArisque']['groupesanguin'];?></td>
